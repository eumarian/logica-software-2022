...
?>		
		...
		<form name="compute" method="get" action="index.php">
			...
			<br />Run variant: 
			<label><input type="radio" name="as_use" value="all" <?= !in_array($run_param,['nc','noas','dn']) ? ' checked="checked"' : '' ?> /> Full</label>
