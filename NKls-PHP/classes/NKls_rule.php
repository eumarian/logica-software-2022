...
abstract class NKls_rule{	
	public static $ops = array(
					'~' => array('key' => '~', 'short' => 'neg', 'name' => 'negation', 'binary' => false, 'lng' => 'not'),
					'&' => array('key' => '&', 'short' => 'conj', 'name' => 'conjunction', 'binary' => true, 'lng' => 'and'),
					'V' => array('key' => 'V', 'short' => 'disj', 'name' => 'disjunction', 'binary' => true, 'lng' => 'or'),
					'->' => array('key' => '->', 'short' => 'impl', 'name' => 'implication', 'binary' => true, 'lng' => 'implies'),
					'<->' => array('key' => '<->', 'short' => 'equiv', 'name' => 'equivalence', 'binary' => true, 'lng' => 'just in case'),
				);
